...
def norm_act_from_config(body_config):
    ...
    if mode == "bn":
        ...
        norm_act_2d = norm_act_3d = norm_act_static = partial(InPlaceABNSync, activation=activation, activation_param=slope)
    elif mode == "syncbn+bn":
        ...
        raise ValueError("Unrecognized normalization_mode {}, valid options: 'bn', 'syncbn', 'syncbn+bn'".format(mode))

    return norm_act_2d, norm_act_3d, norm_act_static
