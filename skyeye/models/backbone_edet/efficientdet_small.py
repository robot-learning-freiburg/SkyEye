...
from skyeye.models.backbone_edet.efficientnet import EfficientNet as EffNet
from skyeye.models.backbone_edet.efficientnet_utils import MemoryEfficientSwish, Swish
from skyeye.models.backbone_edet.efficientnet_utils_extra import Conv2dStaticSamePadding, MaxPool2dStaticSamePadding
from skyeye.models.backbone_edet.efficientdet_utils import Anchors, load_pretrained_weights
...
class BiFPN(nn.Module):
    ...
    def _forward_fast_attention(self, inputs):
        ...
        temp = self.p6_upsample(p7_in)
        temp = F.interpolate(temp, p6_in.shape[-2:])
        p6_up = self.conv6_up(self.swish(weight[0] * p6_in + weight[1] * temp))
